...
class T411 :
	...
	def __init__(self, username = None, password = None) :
		"""	Get user credentials and authentificate it, if any credentials defined use token stored in user file """
		...
		if username == None or password == None :
			...
			try :
				...
				print('Error, you have to define an user and password. Signup at http://www.t411.me/users/signup/')
			...
			try :
				...
				print('Error, user file seems to be wrong. Restart with credentials informations')
		else :
